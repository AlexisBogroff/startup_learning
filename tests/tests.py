...
def setUp_test():
    ...
    p_test11 = PassDynMCQTest(id_test="1", id_student="1", attempt=1, q_num="1",
                              r_ans="1")  # Bonne réponse
    p_test12 = PassDynMCQTest(id_test="1", id_student="1", attempt=1, q_num="2",
                              r_ans="2")  # Mauvaise réponse
    p_test13 = PassDynMCQTest(id_test="1", id_student="1", attempt=1, q_num="3",
                              r_ans="1")  # Mauvaise réponse

    p_test2 = PassDynMCQTestInfo(id_test="1", id_student="2", attempt=1)
    p_test21 = PassDynMCQTest(id_test="1", id_student="2", attempt=1, q_num="1",
                              r_ans="1")  # Bonne réponse
    p_test22 = PassDynMCQTest(id_test="1", id_student="2", attempt=1, q_num="2",
                              r_ans="3")  # Bonne réponse
    p_test23 = PassDynMCQTest(id_test="1", id_student="2", attempt=1, q_num="3",
                              r_ans="2")  # Bonne réponse

    p_test3 = PassDynMCQTestInfo(id_test="1", id_student="3", attempt=1)
    p_test31 = PassDynMCQTest(id_test="1", id_student="3", attempt=1, q_num="1",
                              r_ans="1")  # Bonne réponse
    p_test32 = PassDynMCQTest(id_test="1", id_student="3", attempt=1, q_num="2",
                              r_ans="3")  # Bonne réponse
    p_test33 = PassDynMCQTest(id_test="1", id_student="3", attempt=1, q_num="3",
                              r_ans="1")  # Mauvaise réponse
...
class DumbModelTests(TestCase):
    ...
    def test_pass_testslist_teacher_view(self):
        ...
        login_user(c)
        setUp_test()
        Pass_DynMCQtestInfo_all = PassDynMCQTestInfo.objects.all()
    ...
    def test_Manage_questions_view(self):
        ...
        self.assertEqual([MCQquestions_list, Dynquestions_list],
                         [DynMCQquestions_all_list, Dynquestions_all_list])
